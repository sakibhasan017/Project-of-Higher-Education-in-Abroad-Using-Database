...
<header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="myAccount.php"><span class="profile-icon">&#x1F464;</span><?php echo $namef; ?>'s Account</a></li>
    ...
    <main>
    <div class="container">
            <h2>Welcome to Your Account, <?php echo $name; ?></h2>
            <div class="info">
                <label>Email:</label>
                <p><?php echo $email; ?></p>
            </div>
            ...
            <a href="updateProfile.php" class="btn">Edit Account</a>
            <a href="appHis.php?email=<?php echo urlencode($email); ?>" class="btn">Application History</a>
