...
<header>
        ...
        <nav>
            <ul>
            <li><a href="homeParent.php?email=<?php echo urlencode($email); ?>">Home</a></li>
            <li><a href="InstituteParent.php?email=<?php echo urlencode($email); ?>">Institute</a></li>
                <li><a href="accountInfoParent.php?email=<?php echo urlencode($email); ?>">Account Information</a></li>
    ...
    <div class="container">
            ...
            <a href="appHisFromDetailsP.php?email=<?php echo urlencode($email); ?>" class="btn">Application History</a>
