...
<header>
            ...
            if ($result->num_rows > 0) {
                ...
                if ($resultt->num_rows > 0) {
                    ...
                    while ($program_row = $resultt->fetch_assoc()) {
                        echo "<tr><td><a href='facultyInfo.php?prog_ID={$program_row['Prog_ID']}'>{$program_row['Program_Name']}</a></td><td>{$program_row['Tuition_Fee']}</td></tr>";
                    }
                    echo "</table>";
                } else {
    ...
    <a href="loginUser.php" style="color: white; text-decoration: none;">Apply Now</a>
</div>
