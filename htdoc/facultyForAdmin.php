...
if (isset($_GET['prog_ID'])) {
    $selectedProgramID = mysqli_real_escape_string($con, $_GET['prog_ID']);
}
...
$sql = "SELECT Faculty_ID, Faculty_name, Designation, Email FROM faculty";
...
<header>
    ...
    <button type="submit">Search</button>
        ...
        <div>
            ...
            <table>
                    ...
                    <?php foreach ($facultyList as $faculty) : ?>
                        <tr>
                            ...
                            <td>
                            <a href='deleteFaculty.php?faculty_ID=<?php echo $faculty['Faculty_ID']; ?>' onclick='return confirm("Are you sure you want to delete this faculty member?");'>Delete</a>
            ...
            <?php
            echo "<a href='addFacultys.php?prog_ID=$selectedProgramID'><button>Add More Faculty</button></a>";
                echo "<br>";
                ?>
        </div>
    </div>
